                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\Laptop Code\Desktop\muhammed\School-Mangement-System-master\School-Mangement-System-master\SchoolMangementSystem\Resources\NewFolder2\", teacher_id.Text.Trim() + ".jpg");
