...
using SchoolMangementSystem.Properties;
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkSID = new SqlCommand(checkStudentID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                //string path = Path.Combine(@"C:\Users\Molham Team\Downloads\School-Management-System-using-CSharp-main\School-Management-System-using-CSharp-main\SchoolMangementSystem\SchoolMangementSystem\Student_Directory\", student_id.Text.Trim() + ".jpg");
                                string path = Path.Combine(@"C:\Users\Laptop Code\Desktop\muhammed\School - Mangement - System - master\School - Mangement - System - master\SchoolMangementSystem\Resources\NewFolder1\", student_id.Text.Trim() + ".jpg");
